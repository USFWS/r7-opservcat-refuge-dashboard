...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    #     tabName = "stats",
              ...
              div(id = "message1", h1("Instructions"), h3("To view content, ", strong("select your refuge"), " on the menu to the left."), br(), h3(em("To collapse or expand the menu, click the three bars at the top of the screen."))),
              hidden(div(id = "page1",
              fluidRow(
                useShinyjs(),
                #use_shinyscroll(),
